...
class Student:
    def __init__(self, root):
        ...
        m_title = Label(Manage_Frame, text="Inventaire",  bg="green", fg="white", font=("times new roman", 20, "bold"))
        m_title.grid(row=0, columnspan=2, pady=20)
       
        lbl_roll = Label(Manage_Frame, text="Nom de matérial",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_name = Label(Manage_Frame, text="Référence",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_email = Label(Manage_Frame, text="Emplacement",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_gender = Label(Manage_Frame, text="Désignation",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_dob = Label(Manage_Frame, text="Stock",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_address = Label(Manage_Frame, text="Autres infos",  bg="green", fg="white", font=("times new roman", 18, "bold"))
        ...
        lbl_search = Label(Detail_Frame, width=8, text="Search By",  bg="green", fg="white", font=("times new roman", 15, "bold"))
        ...
        self.Student_table.heading("roll", text="Nom de Matériel")
        self.Student_table.heading("name", text="Name")
        self.Student_table.heading("email", text="Référence")
